...
(function () {
  ...
  (function initScrollReveal() {
    ...
    const groups = [
      ...
      { sel: '.about-visual',                                                   stagger: 0, cls: 'from-right' },
      { sel: '.about-content .section-tag',                                     stagger: 0, cls: 'from-left' },
      { sel: '.about-title',                                                    stagger: 0, cls: 'from-left', delay: 100 },
      { sel: '.about-text',                                                     stagger: 100, cls: 'from-left', delay: 200 },
      { sel: '.value-item',                                                     stagger: 80, cls: 'scale-reveal' },
