...
const products = {
  ...
  'magnesium': {
    ...
    shortDesc: 'مكمل غذائي بالمغنيزيوم — 60 كبسولة، 500mg لكل كبسولة',
    fullDesc: 'مغنيزيوم رحيق بيو يوفر المغنيزيوم على شكل غليسينات، في كبسولات سهلة الاستعمال، بتركيز 500 ملغ في كل كبسولة، ضمن عبوة تحتوي على 60 كبسولة حلال.',
    benefits: [
